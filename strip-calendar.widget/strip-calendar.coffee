{
  ...
  _converticalMilliSecondsToHours: (value) ->
  ...
  _toordinal: (date) ->
    ...
    _zeroDays = Math.abs(@converticalMilliSecondsToHours(zeroDate.getTime()))
    _return zeroDays + @converticalMilliSecondsToHours(date.getTime())
